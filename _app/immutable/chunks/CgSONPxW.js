...
export {
  ...
  pop as W,
  is_firefox as X,
  TEMPLATE_FRAGMENT as Y,
  TEMPLATE_USE_IMPORT_NODE as Z,
  user_pre_effect as _,
  array_prototype as a,
  run_all as a0,
  run as a1,
  deep_read_state as a2,
  derived as a3,
  enable_legacy_mode_flag as a4,
  first_child as a5,
  template_effect as a6,
  child as a7,
  reset as a8,
  sibling as a9,
  EACH_ITEM_IMMUTABLE as aA,
  queue_idle_task as aB,
  LOADING_ATTR_SYMBOL as aC,
  get_descriptors as aD,
  is_runes as aE,
  onDestroy as aF,
  $document as aG,
  next as aH,
  ...
  onMount as ac,
  props_invalid_value as ad,
  LEGACY_DERIVED_PROP as ae,
  derived_safe_equal as af,
  PROPS_IS_UPDATED as ag,
  safe_equals as ah,
  mutable_source as ai,
  PROPS_IS_BINDABLE as aj,
  LEGACY_PROPS as ak,
  ...
  state as aq,
  tick as ar,
  EACH_IS_CONTROLLED as as,
  INERT as at,
  EACH_ITEM_REACTIVE as au,
  internal_set as av,
  EACH_INDEX_REACTIVE as aw,
  EACH_IS_ANIMATED as ax,
  pause_children as ay,
  run_out_transitions as az,
  state_prototype_fixed as b,
  set as c,
  get_descriptor as d,
  active_effect as e,
  state_descriptors_fixed as f,
  get as g,
