import { a as assign_nodes, e as create_fragment_from_html, t as template, b as append, c as comment } from "../chunks/BDSO5bsW.js";
import { B as set_active_reaction, C as set_active_effect, D as active_reaction, e as active_effect, F as create_text, j as block, as as EACH_IS_CONTROLLED, n as set_hydrate_node, k as hydrating, J as get_first_child, l as hydrate_next, g as get$1, af as derived_safe_equal, m as HYDRATION_START_ELSE, r as remove_nodes, p as set_hydrating, v as hydrate_node, M as HYDRATION_END, q as resume_effect, t as branch, u as pause_effect, at as INERT, Q as array_from, z as queue_micro_task, au as EACH_ITEM_REACTIVE, av as internal_set, aw as EACH_INDEX_REACTIVE, ai as mutable_source, s as source, ax as EACH_IS_ANIMATED, ay as pause_children, P as clear_text_content, az as run_out_transitions, ab as destroy_effect, aA as EACH_ITEM_IMMUTABLE, I as get_next_sibling, i as is_array, N as hydration_mismatch, L as HYDRATION_ERROR, aB as queue_idle_task, aC as LOADING_ATTR_SYMBOL, h as get_prototype_of, aD as get_descriptors, y as untrack, x as render_effect, aE as is_runes, T as push, ac as onMount, a6 as template_effect, W as pop, c as set, aq as state, $ as user_effect, aF as onDestroy, a5 as first_child, a7 as child, a9 as sibling, a3 as derived, aG as $document, aH as next, a8 as reset } from "../chunks/CgSONPxW.js";
import { d as delegate, a as head, s as set_text } from "../chunks/BqqE4uZX.js";
import { p as proxy, b as bind_this, i as if_block } from "../chunks/DnOg1er5.js";
...
var root$1 = template(`<button aria-label="Scroll to top"><span class="icon-[akar-icons--align-to-top]" style="width: 26px; height: 26px;"></span></button>`);
...
var root_2 = template(`<div class="fixed inset-0 z-30 bg-black/50 transition-opacity sm:hidden"></div>`);
...
function _page($$anchor, $$props) {
  ...
  let formatedData = derived(() => formatData($$props.data.data));
  let flattenedData = derived(() => flattenData(get$1(formatedData)));
  user_effect(() => {
  ...
  function handleSearch() {
    ...
    set(selectedFolder, proxy([]));
    set(searchResults, proxy(get$1(searchTerm) ? fuseInstance.search(get$1(searchTerm)) : get$1(flattenedData)));
  }
  ...
  function handleFolderClick(folderPath) {
    set(selectedFolder, proxy(folderPath ? folderPath.split("%") : []));
    set(searchResults, proxy([]));
    set(searchTerm, "");
  ...
  each(div_9, 21, () => get$1(filteredResults), index, ($$anchor2, item) => {
    ...
    var node_4 = first_child(fragment_2);
    {
      var consequent_2 = ($$anchor3) => {
        ...
        html(node_5, () => {
          var _a;
          return ((_a = get$1(item).matches) == null ? void 0 : _a.find((m) => m.key === "title")) ? highlightText(get$1(item).item.title, get$1(item).matches.find((m) => m.key === "title").indices) : get$1(item).item.title;
        });
        reset(h2);
        var p = sibling(h2, 2);
        ...
        html(node_6, () => {
          var _a;
          return ((_a = get$1(item).matches) == null ? void 0 : _a.find((m) => m.key === "description")) ? highlightText(get$1(item).item.description, get$1(item).matches.find((m) => m.key === "description").indices) : get$1(item).item.description;
        });
        reset(p_1);
        reset(div_12);
        reset(div_10);
        template_effect(() => {
          set_attribute(a_5, "href", get$1(item).item.url);
          set_attribute(img, "src", `https://www.google.com/s2/favicons?domain=${get$1(item).item.url}&sz=32`);
          set_text(text_3, get$1(item).item.url);
          set_attribute(div_12, "data-tip", get$1(item).item.description);
        });
      ...
      var alternate = ($$anchor3, $$elseif) => {
        {
          ...
          var alternate_1 = ($$anchor4) => {
            ...
            template_effect(() => {
              ...
              set_attribute(img_1, "src", `https://www.google.com/s2/favicons?domain=${get$1(item).url}&sz=32`);
